    ...
    <div className="main flex h-[100vh]">
      <div className="left-half w-[50%] flex flex-col align-center justify-center ">
        ...
        <div className="sign-in-form flex flex-col items-center justify-center mt-5 space-y-7">
          <div className="flex items-center justify-between w-[50%] h-12 rounded-[7px] p-4 bg-[#E4DEDE]">
            <input
              type="email"
          ...
          <div className="flex items-center justify-between w-[50%] h-12 rounded-[7px] p-4 bg-[#E4DEDE]">
            <input
              ...
              className="bg-[#E4DEDE] border-hidden w-[100%] h-12 p-4 focus:outline-none"
              placeholder="Password"
            />
            <p onClick={handelClick} className="text-xl cursor-pointer">
